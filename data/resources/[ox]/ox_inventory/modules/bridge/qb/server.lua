...
RegisterServerEvent('consumables:server:addHunger', function(value)
    local source = source
    local player = exports.qbx_core:GetPlayer(source)

    player.Functions.SetMetaData('hunger', value)

	TriggerClientEvent('hud:client:UpdateNeeds', source, value, player.PlayerData.metadata.thirst)

	player.Functions.Save()

	print("Faim actuelle : " .. value)
end) 

RegisterServerEvent('consumables:server:addThirst', function(value)
    local source = source
    local player = exports.qbx_core:GetPlayer(source)
